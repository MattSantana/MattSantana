...
**XR:** MRTK2 · MRTK3 · HoloLens 2 · PICO XR · Meta Quest · AR Foundation  
**Platforms:** Android · iOS · PC · WebGL
---
### Currently working on
- **Magic Box** — enterprise Mixed Reality solution for industrial training (MRTK3 migration)
- **Cat-a-tonic** — 2D top-down roguelike, exploring OOP + DOD patterns
- **AR Furniture Visualizer** — AR Foundation mobile app for furniture pre-visualization
---
### Stats
<div align="center">
